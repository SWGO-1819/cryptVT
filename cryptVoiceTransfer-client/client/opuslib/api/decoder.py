...
from client.opuslib import api
...
libopus_get_size = api.libopus.opus_decoder_get_size
...
libopus_create = api.libopus.opus_decoder_create
...
libopus_packet_get_bandwidth = api.libopus.opus_packet_get_bandwidth
...
libopus_packet_get_nb_channels = api.libopus.opus_packet_get_nb_channels  # NOQA
# `argtypes` must be a sequence (,) of types!
...
libopus_packet_get_nb_frames = api.libopus.opus_packet_get_nb_frames
...
libopus_packet_get_samples_per_frame = \
    api.libopus.opus_packet_get_samples_per_frame
...
libopus_get_nb_samples = api.libopus.opus_decoder_get_nb_samples
...
libopus_decode = api.libopus.opus_decode
...
def decode(  # pylint: disable=too-many-arguments
    ...
    pcm_pointer = ctypes.cast(pcm, api.c_int16_pointer)
...
libopus_decode_float = api.libopus.opus_decode_float
...
def decode_float(  # pylint: disable=too-many-arguments
    ...
    pcm_pointer = ctypes.cast(pcm, api.c_float_pointer)
...
libopus_ctl = api.libopus.opus_decoder_ctl
...
destroy = api.libopus.opus_decoder_destroy
