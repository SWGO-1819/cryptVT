...
try:
    ...
    raise RuntimeError(f"[!] Failed to load libopus DLL: {dll_path}\n{e}")
...
libopus_get_size = api.libopus.opus_encoder_get_size
...
libopus_create = api.libopus.opus_encoder_create
...
libopus_ctl = api.libopus.opus_encoder_ctl
...
libopus_encode = api.libopus.opus_encode
...
def encode(
    ...
    """
    pcm_pointer = ctypes.cast(pcm_data, api.c_int16_pointer)
...
libopus_encode_float = api.libopus.opus_encode_float
...
def encode_float(
    ...
    pcm_pointer = ctypes.cast(pcm_data, api.c_float_pointer)
    opus_data = (ctypes.c_char * max_data_bytes)()
...
destroy = api.libopus.opus_encoder_destroy
